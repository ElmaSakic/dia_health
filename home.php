...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#navbar" data-offset="150">
    ...
    <nav class="navbar navbar-expand-lg  fixed-top navbar-dark" style="background-color: #000; id ="navbar">
        <a class="navbar-brand" href="#"><img src="photos/drop.png" style="width:20px; margin-bottom: 10px; margin-right: 18px;">Dia<span style="color:#F83897;">Health</span></a>
      ...
      <div class=" container" id="panel" style="padding-top: 100px;">
        <h1 class="card-header" style="text-align: left;">Panel</h1>
        
      </div>

   <div class=" container" id="workshop" style="padding-top: 20px;">
    ...
    <div class="container" id="content" >
                        ...
                        <div class="card ">
                          <div class="card-body">
                            ...
                            <p id ="a1c_card" class="card-text" style="padding: 20px 20px 0 20px; text-align: center;">
                             ...
                             <?php echo '('.(round($rez['avgSugar'],1)).' mmol/L)';?>
                            </p>
        ...
        <div class="col-sm-6" style="float: right;  border:1px solid grey; border-radius: 1%;">
          <div class="col">Graph chart

            <div class="panel panel-default">
                <div id="chart_panel" class="panel-body" style="width:100%;height:370px"></div>
            </div>
    ...
    <div class=" row col-sm-12 col-md-12" id="table" style="padding-top: 50px;">
      <div class="container">
          <div class="row "><span class = "container" style=" text-align: left; font-weight: bold; margin-bottom: 10px;">Showing last 10 entries:</span>
                      ...
                      <div class="panel-body">
                          <table id="glucose_table" class="display responsive table-striped" width="100%">
                              ...
                              <?php
                                  ...
                                  $sql="SELECT sugar, category, dateParim FROM data Limit 10";
                                  $result = $link->query($sql);
